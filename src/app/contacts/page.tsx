...
export const metadata = {
  title: "Контакти — TALIRA",
  description: "Зв'яжіться з нами: телефон, Telegram, Instagram, email",
};
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "20px 48px", fontSize: "11px", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--text-dim)" }} className="container-pad">
        ...
        <span style={{ color: "var(--ink)" }}>Контакти</span>
      </div>

      <section style={{ padding: "20px 0 80px" }}>
        <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 48px" }} className="container-pad">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }} className="grid-specs">

            {/* Left */}
            <div>
              <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 400, marginBottom: "20px" }}>
                Зв&apos;яжіться{" "}
                <em style={{ color: "var(--gold-deep)", fontStyle: "italic", fontWeight: 300 }}>з нами</em>
              </h1>
              <p style={{ fontSize: "15px", color: "var(--text)", lineHeight: "1.75", marginBottom: "40px", maxWidth: "480px" }}>
                Ми завжди на зв&apos;язку. Оберіть зручний спосіб комунікації — відповідаємо швидко та з увагою до деталей.
              </p>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
                ...
                <ContactItem
                  ...
                  label="Instagram"
                  value="@talira.com.ua"
                  sub="Новинки, відгуки, сторіс"
                />
                <ContactItem
                  icon="📧"
                  label="Email"
                  value="hello@talira.com.ua"
                  sub="Для співпраці та пропозицій"
                />
              </div>
            </div>
            ...
            <div style={{ background: "var(--paper)", border: "1px solid var(--line-soft)", padding: "40px" }}>
              ...
              <div style={{ padding: "24px", background: "var(--bg)", border: "1px solid var(--line-soft)", marginBottom: "24px" }}>
                <h4 style={{ fontSize: "11px", letterSpacing: ".22em", textTransform: "uppercase", color: "var(--gold-deep)", fontWeight: 600, marginBottom: "12px", fontFamily: "'Inter', sans-serif" }}>
                  Обробка замовлень
                </h4>
                <p style={{ fontSize: "14px", color: "var(--text)", lineHeight: "1.65" }}>
                  Замовлення оброблюються щодня. Відправка Новою Поштою до 17:00 (крім неділі).
                  Після оформлення замовлення ми зателефонуємо для підтвердження протягом 15–30 хвилин.
                </p>
              </div>

              <div style={{ padding: "24px", background: "var(--ink)", color: "var(--bg)", textAlign: "center" }}>
                <p style={{ fontSize: "12px", letterSpacing: ".15em", textTransform: "uppercase", marginBottom: "8px", color: "var(--gold-soft)" }}>
                  Швидкий зв&apos;язок
                </p>
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "22px" }}>
                  Напишіть нам у Telegram — відповімо за 5 хвилин
                </p>
              </div>
            </div>
          </div>
