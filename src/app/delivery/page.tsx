    ...
    <>
      ...
      <section style={{ padding: "20px 0 60px", borderBottom: "1px solid var(--line)" }}>
        <div className="container-pad" style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 48px" }}>
          ...
          <p style={{ fontSize: "15px", color: "var(--text)", maxWidth: "600px", lineHeight: "1.7" }}>Відправляємо замовлення щодня. Оплата при отриманні.</p>
        </div>
      </section>
      ...
      <section style={{ padding: "60px 0 80px" }}>
        <div className="container-pad grid-specs" style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 48px" }}>
          <div>
            ...
            <InfoBlock title="Нова Пошта" items={["Доставка по всій Україні у будь-яке відділення", "Термін: 1–3 робочих дні", "Безкоштовна доставка від 2 000 ₴", "До 2 000 ₴ — за тарифами Нової Пошти"]} />
            <InfoBlock title="Графік відправок" items={[
              "Понеділок — Четвер: відправка до 16:00",
              "Субота: відправка до 14:00",
              "П'ятниця та Неділя: відправок немає",
            ]} />
      ...
      <section style={{ padding: "60px 0 80px", background: "var(--bg-soft)" }}>
        <div className="container-pad" style={{ maxWidth: "800px", margin: "0 auto", padding: "0 48px" }}>
          ...
          <FaqItem q="Як швидко відправляєте?" a="Пн–Чт до 16:00, Сб до 14:00 — того ж дня. П'ятниця та неділя — відправок немає." />
