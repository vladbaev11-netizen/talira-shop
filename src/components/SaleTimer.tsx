...
export default function SaleTimer() {
  ...
  return (
    ...
    >
      <div style={{ fontSize: "12px", letterSpacing: ".15em", textTransform: "uppercase", color: "var(--gold-soft)", fontWeight: 500 }}>
        Акція закінчується:
      </div>
      <div style={{ display: "flex", gap: "8px" }}>
        <TimeBlock value={pad(timeLeft.hours)} label="год" />
        <div style={{ color: "var(--gold-soft)", fontSize: "20px", fontFamily: "'Cormorant Garamond', serif", lineHeight: "1", alignSelf: "flex-start", marginTop: "2px" }}>:</div>
